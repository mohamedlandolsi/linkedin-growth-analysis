...
Run this to test the scraper with the Klarna post
"""
...
def test_scraper():
    """Test the LinkedIn scraper with the Klarna post."""
    
    # The post URL to scrape
    ...
    print("\n" + "="*70)
    print("LINKEDIN POST SCRAPER - TEST RUN")
    print("="*70)
    print(f"\nTarget URL: {post_url}")
